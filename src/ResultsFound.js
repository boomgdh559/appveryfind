    ...
    return (
      ...
      <ImageBackground style={styles.ImageBackground} source={img}>
        ...
        <View style={styles.container3}>
          ...
          <Image source={require('../assets/found4.png')} style={styles.img2}></Image>
          <View>
            <Text style={{ fontWeight: 'bold', textAlign: 'center', color: '#2A18A0', fontSize: 16, paddingBottom: 10 }}>{stdName}</Text>
            <Text style={{ textAlign: 'center', color: '#2A18A0', fontSize: 15, margin: 3 }}>Degree of conferred : {stdDegree}</Text>
            <Text style={{ textAlign: 'center', color: '#2A18A0', fontSize: 15, margin: 3 }}>Date of graduation : {stdDate}</Text>
            <Text style={{ fontWeight: 'bold', textAlign: 'center', color: '#2A18A0', fontSize: 15, margin: 7 }}>GPA : {stdGPA}</Text>
            <Button
              bordered
              block={true}
              style={styles.buttonStyles}
              onPress={() => {
                // this.props.switchScreen('more');
                this.props.navigation.replace('MoreInformation', {
